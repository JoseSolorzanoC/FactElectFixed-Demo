...
namespace FactElectFixed.Api.Features.Factura.Firma.Xml;
...
public class FacturaXmlModel
{
    ...
    [XmlElement("infoFactura", Order = 2)]
...
{
    [XmlElement("ambiente", Order = 1)]
    public int Ambiente { get; set; }

    [XmlElement("tipoEmision", Order = 2)]
    public int TipoEmision { get; set; }

    [XmlElement("razonSocial", Order = 3)]
    public string RazonSocial { get; set; }

    [XmlElement("nombreComercial", Order = 4)]
    public string NombreComercial { get; set; }

    [XmlElement("ruc", Order = 5)]
    public string Ruc { get; set; }

    [XmlElement("claveAcceso", Order = 6)]
    public string ClaveAcceso { get; set; }

    [XmlElement("codDoc", Order = 7)]
    public string CodDoc { get; set; }

    [XmlElement("estab", Order = 8)]
    public string Estab { get; set; }

    [XmlElement("ptoEmi", Order = 9)]
    public string PtoEmi { get; set; }

    [XmlElement("secuencial", Order = 10)]
    public string Secuencial { get; set; }

    [XmlElement("dirMatriz", Order = 11)]
...
#pragma warning disable S6580
        get => FechaEmision.ToString("dd/MM/yyyy"); set => FechaEmision = DateTime.ParseExact(value, "dd/MM/yyyy", null);
...
public class Detalle
{
    ...
    [XmlElement("descripcion", Order = 3)]
    public string Descripcion { get; set; }

    [XmlElement("cantidad", Order = 4)]
    public decimal Cantidad { get; set; }

    [XmlElement("precioUnitario", Order = 5)]
    public decimal PrecioUnitario { get; set; }

    [XmlElement("descuento", Order = 6)]
...
public class Impuesto
{
    ...
    [XmlElement("valor", Order = 5)]
    public decimal Valor { get; set; }
}

public class Rubro
{
    [XmlElement("concepto", Order = 1)]
