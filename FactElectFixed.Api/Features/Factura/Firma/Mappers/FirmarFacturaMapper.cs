...
namespace FactElectFixed.Api.Features.Factura.Firma.Mappers;

public static class FirmarFacturaMapper
{
    public static FacturaXmlModel ToXml(this  Requests.Factura f)
    {
...
#pragma warning disable CA1305
                ClaveAcceso = Utils.GenerarClaveAcceso(EnumTipoDocumento.Factura, f.InfoFactura.FechaEmision, new PuntoEmision() { Codigo = int.Parse(f.InfoTributaria.PtoEmi), Establecimiento = new Establecimiento() { Codigo = int.Parse(f.InfoTributaria.Estab), Emisor = new Emisor() { RUC = f.InfoTributaria.Ruc, EnumTipoAmbiente = EnumTipoAmbiente.Prueba}} }, long.Parse(f.InfoTributaria.Secuencial), EnumTipoEmision.Normal ),
#pragma warning restore CA1305
            ...
            OtrosRubrosTerceros = f.OtrosRubrosTerceros?.Select(r => new Rubro
            {
                Concepto = r.Concepto,
                Total = r.Total
            }).ToList()
